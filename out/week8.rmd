...
An image of this project as of *`r Sys.Date()`* can be accessed by [clicking this link](https://hub.gke2.mybinder.org/user/reedpumn-psy8960-week8-zu0ew8ag/lab/tree/out/week8.rmd). An interactive web app is available by [clicking this link](https://reedpumn.shinyapps.io/shinyweek8/) instead.

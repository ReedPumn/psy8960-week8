...
An image of this project as of *`r Sys.Date()`* can be accessed by [clicking this link](https://mybinder.org/v2/gh/ReedPumn/psy8960-week8/HEAD). An interactive web app is available by [clicking this link](https://mybinder.org/v2/gh/ReedPumn/psy8960-week8/HEAD?urlpath=rstudio) instead.
